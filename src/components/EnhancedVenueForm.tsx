...
const EnhancedVenueForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.business_name && !formData.name) {
      toast.error('Please provide either a business name or venue name');
      return;
    }
    ...
    try {
      const venueData = {
        ...
        name: formData.name || formData.business_name, // Use business name as fallback
        ...
        created_by: user?.id || member?.email, // Use admin user ID or simple member email
        status: 'pending'
      };
        ...
        <Card className="shadow-elegant">
          <CardHeader>
            <CardTitle className="text-2xl text-foreground">
              Add {venueType === 'coffee_shop' ? 'Coffee Shop' : venueType === 'restaurant' ? 'Restaurant' : 'Venue'}
            </CardTitle>
            <CardDescription>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={formData.name}
                    onChange={handleInputChange}
                    placeholder="How it appears in directory"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                {formData.address && (
                  <div className="flex items-center gap-2 mt-2">
                    <GrabLink venue={{ 
                      id: 'temp-id', 
                      business_name: formData.business_name || formData.name || 'New Venue',
                      address: formData.address,
...
export default EnhancedVenueForm;